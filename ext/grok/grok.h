 ...
 *
 */
GRK_API bool GRK_CALLCONV grk_decompress_detect_format_from_file(const char* fileName,
 ...
 *
 */
GRK_API bool GRK_CALLCONV grk_decompress_detect_format_from_buffer(uint8_t* buffer, size_t len,
																   GRK_SUPPORTED_FILE_FMT* fmt);
